...
await runStage("Checking the environment", ["run", "doctor"]);
...
if (skipPackage) {
  console.log("\nSetup complete (packaging skipped).");
  console.log("Run npm run package on macOS to build the application bundle.");
} else {
